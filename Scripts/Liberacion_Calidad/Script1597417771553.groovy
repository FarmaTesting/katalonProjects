...
for (int i = 1; i <= row_control; i++) {
    ...
    if ((((SUMANET_liberacion_calidad == '') && (comitente != '')) && (param_materiales != '')) && (param_ingresa_cuarentena == 
    'ON')) {
        WebUI.openBrowser('')
		...
		WebUI.waitForElementClickable(findTestObject('Sumanet/img_Gestion_Lotes'), 10)
